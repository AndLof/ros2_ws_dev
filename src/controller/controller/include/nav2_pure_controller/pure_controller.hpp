...
#ifndef NAV2__PURE__CONTROLLER__PURE_CONTROLLER_HPP_
#define NAV2__PURE__CONTROLLER__PURE_CONTROLLER_HPP_
...
protected:
  ...
  rclcpp::Logger logger_ {rclcpp::get_logger("PureController")};
  ...
  //std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<custom_msg_srv::msg::Trajectory>> pub_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::PoseStamped>> pub_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<std_msgs::msg::String>> pub_goal;
  geometry_msgs::msg::Point robot_curr_pose;
...
#endif  // NAV2_PURE_CONTROLLER__PURE__CONTROLLER_HPP_
