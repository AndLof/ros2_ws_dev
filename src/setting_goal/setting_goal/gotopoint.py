...
def goal_clbk(goal):
    ...
    t_x = goal.pose.position.x
    t_y = goal.pose.position.y 
    print(goal.pose.position.x, goal.pose.position.y, goal.pose.position.z, goal.pose.orientation.x, goal.pose.orientation.y, goal.pose.orientation.z, goal.pose.orientation.w)
...
#    rospy.Subscriber("goaltospot", TrajectoryActionGoal, goal_clbk)    
    ...
    node.create_subscription(Float32, "/rotation", rot_clbk, 10)
    node.create_subscription(PoseStamped, "goaltospot", goal_clbk, 10)
