...
#include "custom_msg_srv/msg/detail/trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msg_srv::msg::Trajectory;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msg_srv::msg::Trajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msg_srv::msg::Trajectory *>(
    untyped_ros_message);
...
{
  return &custom_msg_srv::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
