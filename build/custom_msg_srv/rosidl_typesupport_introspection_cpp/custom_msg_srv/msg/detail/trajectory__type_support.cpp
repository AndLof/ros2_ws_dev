...
{
  new (message_memory) custom_msg_srv::msg::Trajectory(_init);
}

void Trajectory_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msg_srv::msg::Trajectory *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Trajectory_message_member_array[1] = {
  {
    ...
    offsetof(custom_msg_srv::msg::Trajectory, target_pose),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Trajectory_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_msg_srv::msg::Trajectory),
...
{
  return &::custom_msg_srv::msg::rosidl_typesupport_introspection_cpp::Trajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msg_srv, msg, Trajectory)() {
  return &::custom_msg_srv::msg::rosidl_typesupport_introspection_cpp::Trajectory_message_type_support_handle;
}
